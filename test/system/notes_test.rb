...
class NotesTest < ApplicationSystemTestCase
  ...
  test "creating a Note" do
    ...
    fill_in "Contenido", with: @note.contenido
    fill_in "Fecha Publicacion", with: @note.fecha_publicacion
    fill_in "Fotos", with: @note.fotos
    fill_in "Fuente", with: @note.fuente
    fill_in "Titulo", with: @note.titulo
